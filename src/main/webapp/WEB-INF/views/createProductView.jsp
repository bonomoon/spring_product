		...
		<div id="content">
			<div class="container">
				...
				<div class="col-md-6">
					<div class="box">
						<h1>상품 등록</h1>
						<p class="lead">팔고 싶은 노트북을 등록해보세요!</p>
						...
						<form action="createProduct" enctype="multipart/form-data"
							...
							<div class="form-group">
								<label for="brand">브랜드</label> <input type="text" name="brand"
									class="form-control" id="brand">
							</div>
							<div class="form-group">
								<label for="cpu">CPU</label> <input type="text" name="cpu"
									class="form-control" id="cpu">
							</div>
							<div class="form-group">
								<label for="graphiccard">그래픽카드</label> <input type="text"
									name="graphiccard" class="form-control" id="graphiccard">
							</div>
							<div class="form-group">
